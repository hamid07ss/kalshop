...
<nav class="top-bar animate-dropdown">
    <div class="container">
        <div class="col-xs-12 col-sm-6 no-margin">
            <ul>
                <li><a href="<?php echo BASE_URL;?>/index.php?page=home">صفحه اصلی</a></li>
                <li class="dropdown">
                    <a class="dropdown-toggle"  data-toggle="dropdown" href="#change-colors">تغییر رنگ</a>
                ...
                <li><a href="index.php?page=blog">بلاگ</a></li>
                <li><a href="index.php?page=faq">پرسش و پاسخ</a></li>
                <li><a href="index.php?page=contact">تماس با ما</a></li>
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#pages">صفحات</a>
                    <ul class="dropdown-menu" role="menu">
...
<!--                    </ul>-->
<!--                </li>-->
<!--                <li><a href="index.php?page=authentication">ثبت نام</a></li>-->
<!--                <li><a href="index.php?page=authentication">ورود</a></li>-->
<!--            </ul>-->
<!--        </div><!-- /.col -->
    </div><!-- /.container -->
</nav><!-- /.top-bar -->
